...
```{r}
tab1(core$V2216, cum.percent = TRUE)
tab1(core$V2216D, cum.percent = TRUE)
...
```{r}
tab1(core$V2219, cum.percent = TRUE)
tab1(core$V2219D, cum.percent = TRUE)
...
tab1(ds2$V1130, cum.percent = TRUE)
...
tab1(ds7$V6393, cum.percent = TRUE)
```
